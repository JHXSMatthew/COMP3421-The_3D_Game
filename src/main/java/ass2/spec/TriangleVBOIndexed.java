...
public class TriangleVBOIndexed implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
         ...
         gl.glBufferData(GL2.GL_ARRAY_BUFFER,    //Type of buffer  
        	        positions.length * MathUtils.sizeOf(Float.class) +  colors.length* MathUtils.sizeOf(Float.class), //size needed
         ...
         gl.glBufferSubData(GL2.GL_ARRAY_BUFFER,
        		 positions.length*MathUtils.sizeOf(Float.class),  //Load after the position data
    ...
    public void display(GLAutoDrawable drawable) {
    	...
    	gl.glEnableClientState(GL2.GL_COLOR_ARRAY);
   	   ...
   	   gl.glColorPointer(3, GL.GL_FLOAT, 0, 
   			             positions.length* MathUtils.sizeOf(Float.class)); //colors are found after the position
